...
const SvgEyeOutline = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" ref={ref} {...props}>
    ...
    <g fill="#000" clipPath="url(#eye-outline_svg__a)">
      <path d="M21.87 11.5c-.64-1.11-4.17-6.69-10.14-6.5-5.53.14-8.73 5-9.6 6.5-.09.15-.14.32-.14.5 0 .17.05.34.14.5.63 1.09 4 6.5 9.89 6.5h.25c5.52-.14 8.74-5 9.6-6.5.08-.16.13-.33.13-.5 0-.18-.05-.35-.13-.5M12.22 17c-4.31.1-7.12-3.59-8.01-5 1.01-1.61 3.62-4.91 7.62-5 4.29-.11 7.11 3.59 8 5-1.04 1.61-3.62 4.9-7.61 5" />
