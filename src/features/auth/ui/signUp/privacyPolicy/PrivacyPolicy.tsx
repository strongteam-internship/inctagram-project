...
import SvgArrowBackOutline from '@/assets/svg/icons/components/ArrowBackOutline'
  ...
  return (
    <div className={s.page}>
      <div className={s.buttonContainer} onClick={() => router.back()}>
        <SvgArrowBackOutline className={s.arrow} />
      ...
      <div className={s.textWrapper}>
        <Typography align={'center'} variant={'regular_text_14'}>
